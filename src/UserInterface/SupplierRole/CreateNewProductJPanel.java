...
public class CreateNewProductJPanel extends javax.swing.JPanel {
    ...
    public CreateNewProductJPanel(JPanel userProcessContainer, Supplier supplier){
        ...
        idField.setText(String.valueOf((Product.getCount()+1)));
    }
    ...
    private void initComponents() {
        ...
        availibilityLabel = new javax.swing.JLabel();
        ...
        availibilityLabel.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        availibilityLabel.setText("Availabilty:");
        add(availibilityLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 230, 90, 30));

        availabilityTxt.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        add(availabilityTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 230, 160, 30));
    }// </editor-fold>//GEN-END:initComponents
    private void createButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createButtonActionPerformed
    // TODO add your handling code here:
        try{
        String prodName = nameField1.getText().trim();
        int price = Integer.parseInt(priceField.getText().trim());
        int availability = Integer.parseInt(availabilityTxt.getText());
        
        if(prodName.length() == 0){
            JOptionPane.showMessageDialog(null, "Please enter a Supplier Name", "Warning Message", JOptionPane.WARNING_MESSAGE);
        }
        else{
            ...
            JOptionPane.showMessageDialog(null, "Product :"+prodName+" has been created", "Success Message", JOptionPane.INFORMATION_MESSAGE);
            nameField1.setText("");
            priceField.setText("");
            ...
            JOptionPane.showMessageDialog(null, "Please enter a valid values", "Warning Message", JOptionPane.WARNING_MESSAGE);
        }
    ...
    private javax.swing.JLabel availibilityLabel;
