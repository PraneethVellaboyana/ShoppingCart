   ...
   Supplier supplier;
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        ...
        layout.next(userProcessContainer);
            ...
            JOptionPane.showMessageDialog(null, "Please provide an existing Product Id.", "Warning Message", JOptionPane.WARNING_MESSAGE);
        }
        }
        catch(NumberFormatException nfe){
            JOptionPane.showMessageDialog(null, "Please Provide a proper Product Id.", "Warning Message", JOptionPane.WARNING_MESSAGE);
        }
